...
<div class="container">
	<div class="row">
		...
		<div class="<?php echo esc_attr( $class ); ?>">
				...
				<div class="share">
					<span class="text"><?php echo esc_html__('Partagez','fashionist'); ?></span>
				...
				<a href="https://www.instagram.com/eleikotunisie" target=_black ><span class="icon-instagram-square"></span></a>
				</div>
