					...
					<div class="item">
						...
						<div class="item-details">
							...
							echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
								'<a href="%s" class="btn-item-delete" title="%s" data-product_id="%s" data-product_sku="%s">Supprimer</a>',
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<div class="item">
		<div class="item-details item-detailsbtn">
			...
			<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="btn-item-delete">Commander</a>   
		</div>	
	</div>
<?php endif; ?>
