        ...
        public function render() {
            ...
            if ( !empty( $this->field['wbc_demo_imports'] ) ) {
                ...
                foreach ( $this->field['wbc_demo_imports'] as $section => $imports ) {
                    ...
                    echo '<div class="wrap-importer theme '.$extra_class.' '.esc_html( apply_filters( 'wbc_importer_directory_title', $imports['directory'] ) ).' " data-demo-id="'.esc_attr( $section ).'"  data-nonce="' . $nonce . '" id="' . $this->field['id'] . '-custom_imports">';
