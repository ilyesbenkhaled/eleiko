...
if ( !function_exists( 'wbc_extended_example' ) ) {
	function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
		...
		*************************************************************************/
		...
		if ( class_exists( 'RevSlider' ) ) {
			...
			$wbc_sliders_array = array(
				'Home page 2' => 'home1.zip', //Set slider zip name
				'Home page 1' => 'home_slider.zip', //Set slider zip name				
			);
		...
		*************************************************************************/
		...
		// If it's demo1 - demo6
		$wbc_menu_array = array( 'Demo Main', 'Home page 1', 'Home page 2');
